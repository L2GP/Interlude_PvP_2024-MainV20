 ...
 * @author fissban
 */
public class NpcBufferScheme2 extends AbstractMods
{
	private static final int NPC_ID = 60013;
	
	private static final String TITLE_NAME = "Buffer";
	
	private static final boolean FREE_BUFFS = ConfigData.NPC_BUFFER_FREE_BUFFS_2;
	
	// precio de usar cada buff, sea del tipo q sea.
	private static final int BUFF_PRICE = ConfigData.NPC_BUFFER_BUFF_PRICE_2;
	
	// precio de los buffs pre-establecidos
	private static final int BUFF_SET_PRICE = ConfigData.NPC_BUFFER_BUFF_SET_PRICE_2;
	// item a cobrar
	private static final int CONSUMABLE_ID = ConfigData.NPC_BUFFER_CONSUMABLE_ID_2;
	...
	private static final int BUFF_REMOVE_PRICE = ConfigData.NPC_BUFFER_BUFF_REMOVE_PRICE_2;
	private static final int SCHEME_BUFF_PRICE = ConfigData.NPC_BUFFER_SCHEME_BUFF_PRICE_2;
	private static final int SCHEMES_PER_PLAYER = ConfigData.NPC_BUFFER_SCHEMES_PER_PLAYER_2;
	
	// maximo de buffs q se pueden agregar de cada tipo por scheme
	private static final int MAX_SCHEME_BUFFS = ConfigData.NPC_BUFFER_MAX_SCHEME_BUFFS_2;
	private static final int MAX_SCHEME_DANCE = ConfigData.NPC_BUFFER_MAX_SCHEME_DANCE_2;
	
	public NpcBufferScheme2()
	{
		registerMod(true);
	}
		...
		switch (bypass)
		{
			...
			case "castBuffSet":
			{
			    if (checkTimeOut(player))
			    {
			        ...
			        if (!getPetbuff)
			        {
			            for (BuffHolder bh : player.isMageClass() ? SchemeBuffData2.getAllMageBuffs2() : SchemeBuffData2.getAllWarriorBuffs2())
			            {
			                SkillTable.getInstance().getInfo(bh.getId(), bh.getLevel()).getEffects(player, player);
			            }
			        }
			        else
			        {
			            if (player.getPet() != null)
			            {
			                ...
			                for (BuffHolder bh : SchemeBuffData2.getAllWarriorBuffs2())
			                {
			                    SkillTable.getInstance().getInfo(bh.getId(), bh.getLevel()).getEffects(player.getPet(), player.getPet());
			                }
			            }
	...
	{	
	    ...
	    if (SkillData.CUSTOM_ICONS.containsKey(id)) // Acceso a CUSTOM_ICONS a través de SkillData
	    {
	        ...
	        return "<button action=\"bypass -h Engine NpcBufferScheme2 description " + id + " " + level + " x\" width=32 height=32 back=\"" + iconName + "\" fore=\"" + iconName + "\">"; // Devuelve el botón con el icono personalizado
	    }

	    // Si no hay un icono personalizado, utiliza la lógica predeterminada
	    String iconNumber = SkillData.getSkillIcon(id);
	    return "<button action=\"bypass -h Engine NpcBufferScheme2 description " + id + " " + level + " x\" width=32 height=32 back=\"Icon.skill" + iconNumber + "\" fore=\"Icon.skill" + iconNumber + "\">";
	}
	...
	private void rebuildMainHtml(Player player)
	{
		...
		if (pet == null || pet.equals("1"))
		{
			...
			hb.append("<button value=\"Pet Options\" action=\"bypass -h Engine NpcBufferScheme2 buffpet 0\" width=75 height=21  back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
		else
		{
			bottonA = "Auto Buff";
			bottonB = "Heal";
			bottonC = "Remove Buffs";
			hb.append("<button value=\"Char Options\" action=\"bypass -h Engine NpcBufferScheme2 buffpet 1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
		...
		hb.append("<td height=32 align=center><button value=Buffs action=\"bypass -h Engine NpcBufferScheme2 redirect_view_buff\" width=75 height=21back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("<td height=32 align=center><img src=Icon.skill1259 height=32 width=32></td>");
		hb.append("<td height=32 align=center><button value=Resist action=\"bypass -h Engine NpcBufferScheme2 redirect_view_resist\" width=75 height=21back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<br>");
		hb.append("<table width=214 cellspacing=0 cellpadding=1>");
		...
		hb.append("<td height=32 align=center><button value=Songs action=\"bypass -h Engine NpcBufferScheme2 redirect_view_song\" width=75 height=21back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("<td height=32 align=center><img src=Icon.skill0271 height=32 width=32></td>");
		hb.append("<td height=32 align=center><button value=Dance action=\"bypass -h Engine NpcBufferScheme2 redirect_view_dance\" width=75 height=21back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<br>");
		...
		hb.append("<td height=32 align=center><button value=Special action=\"bypass -h Engine NpcBufferScheme2 redirect_view_special\" width=75 height=21back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("</tr>");		
		hb.append("</table>");
		hb.append("<br>");
		// ---------------------------------------------------------------------------------------------
		...
		hb.append("<td><button value=\"", bottonA, "\" action=\"bypass -h Engine NpcBufferScheme2 castBuffSet 0 0 0\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");		
		hb.append("<td height=32 align=center><img src=Icon.skill1402 height=32 width=32></td>");
		hb.append("<td><button value=\"", bottonB, "\" action=\"bypass -h Engine NpcBufferScheme2 heal\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<br>");
		hb.append("<table width=107 cellspacing=0 cellpadding=1>");
		...
		hb.append("<td><button value=\"", bottonC, "\" action=\"bypass -h Engine NpcBufferScheme2 removeBuffs 0 0 0\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<br>");		
	...
	private String generateScheme(Player player)
	{
		...
		if (schemeNames != null)
		{
			...
			for (int i = 0; i < schemeNames.split(",").length; ++i)
			{
				...
				hb.append(TRS[td] + "<button value=\"", schemeNames.split(",")[i], "\" action=\"bypass -h Engine NpcBufferScheme2 cast ", schemeNames.split(",")[i], "\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">", TRS[td + 1]);
				td += 2;
			}
		...
		{
			hb.append("<br1><table><tr><td><button value=\"Create\" action=\"bypass -h Engine NpcBufferScheme2 create_1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
		}
		else
		{
		...
		if (schemeNames != null)
		{
			hb.append("<td><button value=\"Edit\" action=\"bypass -h Engine NpcBufferScheme2 edit_1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td><td><button value=\"Delete\" action=\"bypass -h Engine NpcBufferScheme2 delete_1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td></tr></table>");
		}
		else
		{
			hb.append("</tr></table>");
	...
	{
		for (BuffHolder bh : SchemeBuffData2.getAllGeneralBuffs2())
		{
	...
	private static void showText(Player player, String type, String text, boolean buttonEnabled, String buttonName, String location)
	{
		...
		if (buttonEnabled)
		{
			hb.append("<button value=\"" + buttonName + "\" action=\"bypass -h Engine NpcBufferScheme2 redirect_", location, " 0 0\" width=75 height=21  back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
	...
	private static void createScheme(Player player)
	{
		...
		hb.append("<br><br>");
		hb.append("<button value=\"Create Scheme\" action=\"bypass -h Engine NpcBufferScheme2 create $name no_name\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<br>");
		hb.append("<button value=\"Back\" action=\"bypass -h Engine NpcBufferScheme2 redirect_main\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<br>");
		hb.append("<font color=303030>", TITLE_NAME, "</font>");
		hb.append("</center>");
		hb.append("</body></html>");
	...
	private void deleteScheme(Player player)
	{
		...
		{
			hb.append("<button value=\"", scheme, "\" action=\"bypass -h Engine NpcBufferScheme2 delete_c ", scheme, " x\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
		
		hb.append("<br>");
		hb.append("<button value=\"Back\" action=\"bypass -h Engine NpcBufferScheme2redirect_main\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<br>");
		hb.append("<font color=303030>" + TITLE_NAME + "</font>");
		hb.append("</center>");
		hb.append("</body></html>");
	...
	private void editScheme(Player player)
	{
		...
		for (String scheme : schemeNames.split(","))
		{
			hb.append("<button value=\"" + scheme + "\" action=\"bypass -h Engine NpcBufferScheme2 manage_scheme_select " + scheme + "\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
	...
	private void getOptionList(Player player, String scheme)
	{
		...
		{
			hb.append("<button value=\"Add buffs\" action=\"bypass -h Engine NpcBufferScheme2 manage_scheme_add ", scheme, " 1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
		if (bcount > 0)
		{
			hb.append("<button value=\"Remove buffs\" action=\"bypass -h Engine NpcBufferScheme2 manage_scheme_remove ", scheme, " 1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		}
		hb.append("<br>");
		hb.append("<button value=\"Back\" action=\"bypass -h Engine NpcBufferScheme2 edit_1\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<button value=\"Home\" action=\"bypass -h Engine NpcBufferScheme2 redirect_main\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<br>");
	...
	private static void buildHtml(Player player, BuffType buffType, int page)
	{
		...
		else
		{
			...
			for (BuffHolder bh : buffs)
			{
				...
				hb.append("<td height=32 fixwidth=232 align=center><a action=\"bypass -h Engine NpcBufferScheme2 giveBuffs ", bh.getId(), " ", bh.getLevel(), " ", buffType.name(), " ", page, "\">", name, "</a></td>");
				hb.append("<td height=32 fixwidth=32>", getSkillIconHtml(bh.getId(), bh.getLevel()), "</td>");
				hb.append("</tr>");
			...
			for (int i = 0; i < buffs.size(); i++)
			{
				if (i % MAX_PER_PAGE == 0)
				{
					hb.append("<td width=20 align=center><a action=\"bypass -h Engine NpcBufferScheme2 redirect_view_", buffType.name().toLowerCase(), " ", currentPage, "\">", currentPage, "</a></td>");
					currentPage++;
				}
			}
	...
	private void viewAllSchemeBuffs(Player player, String schemeName, String page, String action)
	{
		...
		for (int ii = 1; ii <= pc; ++ii)
		{
			...
			{
				hb.append("<td width=", width, ">", "<a action=\"bypass -h Engine NpcBufferScheme2 manage_scheme_add ", schemeName, " ", ii, " x\">", ii, "</a></td>");
			}
			else if (action.equals("remove"))
			{
				hb.append("<td width=", width, ">", "<a action=\"bypass -h Engine NpcBufferScheme2 manage_scheme_remove ", schemeName, " ", ii, " x\">", ii, "</a></td>");
			}
			else
			{
				throw new RuntimeException();
		...
		for (int i = start; i < end; ++i)
		{
			...
			if (action.equals("add"))
			{
				if (!isUsed(player, schemeName, id, level))
				{
					...
					hb.append("<td><button value=\"Add\" action=\"bypass -h Engine NpcBufferScheme2 add_buff ", schemeName, "_", id, "_", level, " ", page, " ", buffsTotal, "\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
					hb.append("</tr>");
					hb.append("</table>");
					k += 1;
				}
			...
			else if (action.equals("remove"))
			{
				...
				hb.append("<td width=35>", getSkillIconHtml(id, level), "</td>");
				hb.append("<td fixwidth=170>", name, "</td>");
				hb.append("<td><button value=\"Remove\" action=\"bypass -h Engine NpcBufferScheme2 remove_buff ", schemeName, "_", id, "_", level, " ", page, " ", buffsTotal, "\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, "></td>");
				hb.append("</tr>");
				hb.append("</table>");
				k += 1;
			}
		...
		hb.append("<br><br>");
		hb.append("<button value=Back action=\"bypass -h Engine NpcBufferScheme2 manage_scheme_select ", schemeName, "\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<button value=Home action=\"bypass -h Engine NpcBufferScheme2 redirect_main\" width=75 height=21 back=", L2UI_CH3.Btn1_normalOn, " fore=", L2UI_CH3.Btn1_normal, ">");
		hb.append("<br>");
		hb.append("<font color=303030>", TITLE_NAME, "</font>");
		hb.append("</center>");
