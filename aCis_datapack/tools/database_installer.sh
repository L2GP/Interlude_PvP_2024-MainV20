...
# Loginserver
LSDBHOST="localhost"
LSDB="interlude_pvp_2024"
LSUSER="root"
LSPASS=

# Gameserver
GSDBHOST="localhost"
GSDB="interlude_pvp_2024"
GSUSER="root"
GSPASS=
...
$MYG < ../sql/autofarm_ip.sql &> /dev/null
...
$MYG < ../sql/character_autofarm.sql &> /dev/null
...
$MYG < ../sql/characters_dressme_data.sql &> /dev/null
...
$MYG < ../sql/item_icons.sql &> /dev/null
