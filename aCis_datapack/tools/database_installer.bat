...
REM ############################################
REM MYSQL BIN PATH
REM set mysqlBinPath=C:\Program Files\MariaDB 10.4\bin
set mysqlBinPath=C:\xampp\mysql\bin

REM LOGINSERVER
set lsuser=root
set lspass=
set lsdb=interlude_pvp_2024
set lshost=localhost

REM GAMESERVER
set gsuser=root
set gspass=
set gsdb=interlude_pvp_2024
...
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/autofarm_ip.sql
...
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/character_autofarm.sql
...
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/characters_dressme_data.sql
...
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/engine.sql
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/fake_pcs.sql
...
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/item_icons.sql
